...
//     if (!uc) return [];
//     return (UPGRADE_CODE_TO_FEATURES[uc.colorCode] ?? []).filter(f => f !== "ULTRA");
//   })();
...
//                         </select>
//                         {/* Boost — single when not double combo */}
//                         {!isDoubleCombo && (
...
//                           </select>
//                         )}
//                         {/* Boost side picker — double+ultra combo */}
//                         {isDoubleCombo && (
...
//             {isDoubleCombo && " · L/R boost = which side gets boost, ✕ to clear side"}
//           </div>
//         </div>
//       )}
//     </div>
