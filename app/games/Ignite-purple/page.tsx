...
//   // ── Upgrade state ──────────────────────────────────────────────────────────
//   // Carried from a single-feature upgrade into the new combo — baked into the
//   // first SPIN of the new combo, then cleared.
...
//               onSpin={(snap) => setSplitGaffeHistory((p) => [...p, generateSplitFeatureGaffe(snap)])}
//               onReset={() => setSplitGaffeHistory([])}
//               onUpgrade={(newFeatures, _carryCoins, upgradeInfo) => {
//                 // Convert UpgradeInfoSplit → UpgradeInfo for the combo
...
//                 };
//                 setPendingUpgradeInfo(comboUpgradeInfo);
//                 handleGoTo(newFeatures);
//               }}
//             />
//           )}
...
//               onSpin={(snap, line) => {
//                 // Clear pending upgrade after it's been baked into the first spin
...
//                 // Generate the upgrade gaffe line for this combo spin
//                 const line = generateCombinationGaffe(carryCoins, comboConfig, upgradeInfo);
//                 setComboGaffeHistory((p) => [...p, line]);
//                 // Navigate to the new combo
//                 handleGoTo(newFeatures);
//               }}
//             />
//           )}
...
//! latest workinh (without strike as 2nd)
// "use client";
// import { useState, useMemo } from "react";
// import BaseGame from "../Ignite-purple/base-game";
// import GaffeOutput from "../Ignite-purple/components/GaffeOutput";
...
//                   position: c.position, colorCode: c.colorCode, value: c.value, fromBase: true,
//                 }));
