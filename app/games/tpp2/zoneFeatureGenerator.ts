...
export function generateZoneGaffe(
  ...
  // GOLD keeps the array form [value]; PURPLE is now plain value (no seq,
  // no brackets) — its seq value moves into unlockedColorCoinsSymbol below.
  // No multiplierLadderPrize in Zone.
  let pIdx = purpleCoinIdx;
  let purpleSeqVal: string | undefined;
