...
export type ScatKey = "piggyZone" | "piggyTower" | "piggyWheel";
...
export const SCAT_OPTIONS: { key: ScatKey; label: string; name: string }[] = [
  ...
  { key: "piggyTower", label: "BLUE_SCAT",   name: "Blue"   },
...
function selectBg(scatKey?: ScatKey): string {
  if (scatKey === "piggyZone")  return "#7e22ce"; // purple-800
  if (scatKey === "piggyTower") return "#1e3a8a"; // blue-900
  if (scatKey === "piggyWheel") return "#7f1d1d"; // red-900
  return "#1f2937"; // gray-800
}
