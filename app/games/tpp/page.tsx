...
// import { ScatType, ScatKey } from "./ReelColumn";
...
//   const isFeatureActive = activeSection !== "base";
...
//           </button>
//         ) : (
//           /* placeholder Back to match the screenshot's top-left button */
//           <button className="px-4 py-2 rounded-lg text-sm font-medium border border-gray-600 text-gray-200 hover:bg-gray-800 transition-colors opacity-40 cursor-default">
//             ← Back
//           </button>
//         )}
//       </div>
...
//         {/* Left — Base Game + Feature sections */}
...
//               {activeSection.split("-").map((fKey) => (
//                 <div
//                   key={fKey}
//                   className="rounded-2xl p-5 border border-dashed border-gray-600"
//                   style={{ background: "#1e2235" }}
//                 >
//                   <p className={`font-bold text-sm mb-2 ${FEATURE_COLOR[fKey] ?? "text-white"}`}>
//                     {FEATURE_LABEL[fKey] ?? fKey.toUpperCase()} Feature
//                   </p>
//                   <p className="text-gray-400 text-xs mb-2">
//                     Feature component coming soon.
//                   </p>
//                   {featureBaseCoins[fKey]?.length > 0 ? (
//                     <ul className="text-xs text-gray-300 space-y-0.5">
//                       {featureBaseCoins[fKey].map((c, i) => (
//                         <li key={i}>
//                           Grid pos {c.position} → <strong>{c.value}</strong>
//                         </li>
//                       ))}
//                     </ul>
//                   ) : (
//                     <p className="text-xs text-gray-500 italic">
//                       No base coins — set a value on a visible{" "}
//                       {FEATURE_LABEL[fKey]} SCAT.
//                     </p>
//                   )}
//                 </div>
//               ))}
...
//               {/* ── SINGLE: WHEEL ────────────────────────────────────────── */}
//               {!isCombination && activeSection === "wheel" && (
//                 <WheelFeature
...
//               {/* ── SINGLE: ZONE ─────────────────────────────────────────── */}
//               {!isCombination && activeSection === "zone" && (
//                 <ZoneFeature
...
//               {/* ── SINGLE: TOWER ────────────────────────────────────────── */}
//               {!isCombination && activeSection === "tower" && (
//                 <TowerFeature
    ...
    <div className="min-h-screen text-white p-6" style={{ background: "#0d1117" }}>
      ...
      <div className="flex gap-6 items-start">
        ...
        <div className="flex-1 min-w-0 flex flex-col gap-4">
          ...
          {/* ── SINGLE: WHEEL ─────────────────────────────────────────── */}
          {isFeature && !isCombination && activeSection === "wheel" && (
            <WheelFeature
          ...
          {/* ── SINGLE: ZONE ──────────────────────────────────────────── */}
          {isFeature && !isCombination && activeSection === "zone" && (
            <ZoneFeature
              baseCoins={singleBaseCoins}
              onSpin={addSpinLine}
              onReset={clearLines}
          ...
          {/* ── SINGLE: TOWER ─────────────────────────────────────────── */}
          {isFeature && !isCombination && activeSection === "tower" && (
            <TowerFeature
              baseCoins={singleBaseCoins}
              onSpin={addSpinLine}
              onReset={clearLines}
