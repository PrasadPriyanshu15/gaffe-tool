...
//   return features.includes("piggyTower");
// }
...
//   counts:   { red: number; blue: number }
// ): ComboCell["type"] {
//   const hasZone  = features.includes("piggyZone");
//   const hasWheel = features.includes("piggyWheel");
//   const hasTwr   = features.includes("piggyTower");
