 ...
 *
 * Coin palettes (from each *FeatureGenerator):
 *   Zone:   Red(4)→DOUBLE,   Purple(13)→ULTRA,  Blue(22)→EXTRA,  AllColor(31)→all-others
 *   Extra:  Red(4)→DOUBLE,   Purple(13)→ULTRA,  Blue(22)→ZONE,   AllColor(31)→all-others
 *   Double: Purple(4)→ULTRA, Purple(13)→EXTRA,  Blue(22)→ZONE,   AllColor(31)→all-others
 *   Ultra:  Red(4)→DOUBLE,   Purple(13)→EXTRA,  Blue(22)→ZONE,   AllColor(31)→all-others
 *
 * Mapping rules:
 *   - Red(4)   in Zone/Extra/Ultra  → DOUBLE
 *   - Blue(13) in Extra/Ultra       → ZONE
...
export const FEATURE_UPGRADE_MAP: Record<string, Record<number, string[]>> = {
  // 13 = Purple, 22 = Blue
  zone:   { 4: ["DOUBLE"], 13: ["ULTRA"],  22: ["EXTRA"],  31: [] }, // 31 = AllColor → handled specially
  extra:  { 4: ["DOUBLE"], 13: ["ULTRA"],  22: ["ZONE"],   31: [] },
  double: { 4: ["ULTRA"],  13: ["EXTRA"],  22: ["ZONE"],   31: [] },
  ultra:  { 4: ["DOUBLE"], 13: ["EXTRA"],  22: ["ZONE"],   31: [] },
};
